//Carmen Elisa Lopez Alvarado 00100619 trabaje en pareja con Nelson Alexander Evora Diaz 00066819
...
bool eliminarMisterio(){
    int mis = misterio;
    Nodo *p = pInicio, *q = NULL;
    
    while(p != NULL && (p->dato).genero != mis){
    	q = p;
        p = p->sig;
	}
	if(p == NULL){
    ...
    do{
        ...
        switch(opcion){
            ...
            case 2: cout << "Listando..." << endl;
                mostrarLista();
            break;
            case 3: cout << "Eliminando libros de misterio..." << endl;
                if(eliminarMisterio())
